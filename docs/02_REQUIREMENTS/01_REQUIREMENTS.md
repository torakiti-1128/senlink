...
| 機能ID | 機能名 | 説明 |
| :--- | :--- | :--- |
| **F-03-01** | **就活ダッシュボード** | クラス全体の内定率把握および「支援が必要な学生」の自動抽出とアラート表示。 |
...
| 機能ID | 機能名 | 説明 |
| :--- | :--- | :--- |
| **F-03-01** | **権限管理** | 教員アカウントの発行、および管理者権限の付与／剥奪。 |
| **F-03-02** | **クラス管理** | 年度ごとの学科／クラス作成、クラス情報の閲覧。 |
| **F-03-03** | **マスタデータ管理** | 職種勤務地、学科等、システム全体で利用するマスタデータの管理。 |
| **F-03-04** | **設定管理** | システム全体の定数（例：セッション、パスワードポリシー、予約配信設定）の変更、配信。 |
| **F-03-05** | **システム監視** | APIパフォーマンス、エラーログ、DB負荷状況のムモニタリング。 |

...
|---:|---|---|---|---|---|---|
| 1 | 監査ログ一覧 | /api/v1/audit/admin/audit-logs | GET | 必要 | 管理者 | 監査ログを検索・ページング取得 |
| 2 | 監査ログ詳細 | /api/v1/audit/admin/audit-logs/{audit_log_id} | GET | 必要 | 管理者 | 監査ログ詳細（details含む） |
| 3 | エラーログ一覧 | /api/v1/audit/admin/error-logs | GET | 必要 | 管理者 | エラーログを検索・ページング取得 |
| 4 | エラーログ詳細 | /api/v1/audit/admin/error-logs/{error_log_id} | GET | 必要 | 管理者 | エラーログ詳細（stackTrace含む） |
| 5 | メトリクス履歴 | /api/v1/audit/admin/system-metrics | GET | 必要 | 管理者 | メトリクス履歴を範囲指定で取得 |
| 6 | 最新メトリクス（サマリ） | /api/v1/audit/admin/system-metrics/latest | GET | 必要 | 管理者 | componentごとの最新状態 |
| 7 | 運用ダッシュボード | /api/v1/audit/admin/dashboard | GET | 必要 | 管理者 | 監視/運用の集約ビューを返す（管理者画面用） |
